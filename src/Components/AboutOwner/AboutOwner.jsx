...
export default function AboutOwner() {
  return (
    <div className="relative overflow-hidden py-16 flex flex-col   items-center justify-center " >
      <div className="hidden absolute top-0 inset-x-0 h-1/2 lg:block" aria-hidden="true" />
      <div className="max-w-6xl mx-auto bg-indigo-600 lg:bg-transparent lg:px-7">
          ...
          <div className="relative bg-indigo-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              ...
              <p className="text-lg text-white">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores nam perferendis nesciunt. Ullam fugiat eius fuga! Quidem ipsum voluptates quaerat minima. Nostrum obcaecati voluptatum libero quia quisquam beatae mollitia id, consequuntur possimus molestias cum, itaque dolor dolorum maiores fugit numquam.
              </p>
              <a
